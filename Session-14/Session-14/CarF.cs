...
namespace Session_11
{
    public partial class CarF : Form
    {
        ...
        public CarF(CarService carService, IEntityRepo<Car> carRepo)
        {
            InitializeComponent();
        ...
        public CarF(CarService carService, IEntityRepo<Car> carRepo, Car car) : this(carService, carRepo)
        {
            _car = car;
        }
